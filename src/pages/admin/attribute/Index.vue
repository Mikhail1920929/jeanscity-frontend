                            ...
                            >
                                ...
                                <q-item-section side>
                                    <q-btn-group outline rounded>
                                        <q-btn size="sm" :to="`/admin/attributes/edit/${attribute.slug}`" outline color="primary" round icon="edit"/>
...
export default {
  ...
  methods: {
    ...mapActions({
      attributeIndex: 'catalog/attributes/index',
      attributeDestroy: 'catalog/attributes/destroy'
    }),
    filterAttributes () {
