...
export default {
  ...
  methods: {
    ...mapActions({
      callbackShow: 'communications/callbacks/show',
      callbackUpdate: 'communications/callbacks/update',
      callbackIndex: 'communications/callbacks/index',
      callbacksUnanswered: 'communications/callbacks/unanswered',
      answersIndex: 'communications/callbacks/answers/index',
      answerStore: 'communications/callbacks/answers/store'
    }),
    resetAnswer () {
      this.answer = {}
